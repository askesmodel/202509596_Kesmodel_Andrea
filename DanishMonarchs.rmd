...
#It was Kings4 that is the `tidyverse´
2. What is the result of running `class()` on the `kings` object created with a tidyverse function.
#Its a tbl. console answer comes out as such: "spec_tbl_df" "tbl_df"      "tbl"         "data.frame" 
3. How many columns does the object have when created with these different functions?
#kings1 has 1 column, kings2 has 1 column, kings3 has 6 columns, kings4 has 6 columns
...
kings <- read_csv2("data2/Danske_Monarker.csv")
...
{r}
# YOUR CODE
kings$duration <- kings$Regeringsslut_aar-kings$Regeringsstart_aar
